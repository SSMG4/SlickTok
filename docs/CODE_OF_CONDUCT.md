...
Be respectful. Assume good faith. Disagree about code, not about
people.
...
- Harassment, insults, or personal attacks, in any project space.
...
Violations may be addressed by editing, locking, or removing
contributions, and by warning, temporarily banning, or permanently
banning the person involved, at the maintainer's discretion.

## Reporting

Report concerns by opening a private security advisory on the
repository (Repository → Security → Report a vulnerability) if the
issue is sensitive, or a regular issue otherwise.
